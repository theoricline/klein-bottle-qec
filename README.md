...
![Zenodo](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.19202945-blue)
![License: MIT](https://img.shields.io/badge/Code-MIT-green)
![License: CC BY 4.0](https://img.shields.io/badge/Paper-CC%20BY%204.0-lightgrey)
![API](https://img.shields.io/badge/Live%20Demo-kleincode.pythonanywhere.com-purple)
...
Builds the Klein bottle circuit for your chosen δ
Transpiles against your backend (seed=77 by default — see note above)
Submits to IBM Quantum with your credentials
Collects syndrome counts
POSTs counts to `/api/analyse` and prints the full analysis
---
...
GitHub: theoricline/klein-bottle-qec  
API: kleincode.pythonanywhere.com
